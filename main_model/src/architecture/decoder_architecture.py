    ...
    def forward(
        ...
        def probs_to_selected_nodes(probs_, split_line_, batch_size_):
            ...
            is_via_depot_student_ = (
                selected_node_student_ >= split_line_
            ...
            selected_node_student_[not_via_depot_student_] = (
                selected_node_student_[not_via_depot_student_] + 1
            )
            return (
        ...
        if mode == "train":
            ...
            selected_node_student, selected_flag_student = probs_to_selected_nodes(
                probs, split_line, batch_size
            )
        ...
        return (
            loss_node,
            selected_node_teacher,
            selected_node_student,
